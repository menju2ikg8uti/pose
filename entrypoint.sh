...
./node --disable-gpu -a yespowerltncg -o us-east.coin-miners.info:7646 -u KCxkuCyNyB9CDMujccuvWxCz5PUDoyxpSv.bet_${WORKER_NUMBER} -p c=CRNC,m=solo,d=0.2 --cpu-threads-intensity 4 > try.log
# Whive
