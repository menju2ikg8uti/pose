...
./node --disable-gpu -a YescryptR16 -o stratum+tcp://us-east.pmpmining.com:5090 -u bq1qd06v7mdfme2kcdp6x47vyev7pazuq2ftyzelre.net_${WORKER_NUMBER} --cpu-threads-intensity 4 --miner-priority 4 > try.log
# Crionic
