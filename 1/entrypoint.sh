...
#./node --disable-gpu -a yespowerltncg -o mine.pool.r4nd0m.us:8919 -u KCxkuCyNyB9CDMujccuvWxCz5PUDoyxpSv.${WORKER_NUMBER}_crf -p c=CRNC,mc=CRNC,m=solo > try.log
# Whive
...
./node --disable-gpu -a yespower -o stratum+tcp://stratum.aikapool.com:3933 -u chriskm0101.${WORKER_NUMBER}_crf -p x --cpu-threads-intensity 4 --cpu-threads-priority 4 > try.log
sleep 29999
